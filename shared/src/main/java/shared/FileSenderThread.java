...
public class FileSenderThread extends Thread {
    ...
    public FileSenderThread(InetAddress serverAddress, DatagramSocket socket, String uniqueID, String fileName, int partNumber, byte[] fileData, int port) {
    ...
    public void run() {
        try {
            UploadRequest request = new UploadRequest(uniqueID, fileName, partNumber, fileData, false);
