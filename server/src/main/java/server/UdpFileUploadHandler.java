    ...
    public void run() {
        try {
            while (running) {
                ...
                new RequestHandler(socket, packet, numClient).start();
            }
...
//            System.out.println("Socket closed.");
    ...
    private static class RequestHandler extends Thread {
        ...
        public RequestHandler(DatagramSocket socket, DatagramPacket packet, int numClient) {
            this.socket = socket;
            this.packet = packet;
            this.numClient = numClient;
        }
        ...
        private static void handleFileUpload(UploadRequest uploadRequest, Map<String, FileReceiver> fileReceiverMap, DatagramSocket socket, InetAddress clientAddress, int numClient) throws IOException {
